...
TEKSTY = {
    "uz": {
        ...
        "privet": (
            ...
            "Hech qaysi servis kartaga aynan qancha tushishini oldindan "
            "ko‘rsatmaydi: komissiya bir joyda, kurs boshqa joyda, "
            "qabul qiluvchi bank esa umuman hisobga olinmaydi.\n\n"
    ...
    "ru": {
        ...
        "privet": (
            ...
            "Ни один сервис не показывает заранее, сколько именно ляжет на карту: "
            "комиссия в одном месте, курс в другом, а банк получателя не учитывается "
            "вовсе.\n\n"
