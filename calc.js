...
window.CALC = (function () {
  ...
  function razborKursaCB(spisok, zaprosheno) {
    ...
    /* Обе валюты обязаны быть одного дня.
     *
     * Из этих двух чисел выводится кросс-курс рубль→доллар, и взятые за
     * разные дни они дадут курс, которого не было ни в один из них.
     * Тот же класс ошибки уже ловится в расчёте наценки — «курс банка от
     * одной даты, курс ЦБ от другой»; здесь он ловится в источнике. */
    if (vISO(rub.Date) !== opublikovano) return null;
